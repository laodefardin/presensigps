    ...
    <tr>
        ...
        <td>
            @if ($d->jam_in > '07:00')
                ...
                @endphp
                <span class="badge bg-red text-red-fg">Terlambat {{ $jamterlambat }}</span>
            @else
...
<script>
    $(function(){
        $(".tampilkanpeta").click(function(e){
            var id = $(this).attr("id"); // variabel ini menampung value dari atribut dari id
            $.ajax({
                type: 'POST',
                url: '/tampilkanpeta',
                data: {
                ...
                cache: false,
                // ketika kita berhasil mengakses halaman tampilkanpeta maka return nilainya akan ditampung respond dan akan kita tampilkan di id loadmap pada modal yang berada di monitpring.blade.php
