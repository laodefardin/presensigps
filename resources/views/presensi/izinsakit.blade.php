                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('sampai') }}" id="sampai" name="sampai"
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('email') }}" id="email" name="email"
                            ...
                            <div class="col-3">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('nama_lengkap') }}" id="nama_lengkap" name="nama_lengkap"
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($d->status_approved == 1)
                                        <span class="badge bg-green text-green-fg">Disetujui</span>
