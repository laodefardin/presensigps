 ...
 <div id="appCapsule">
    ...
    <div class="section mt-2" id="presence-section">
        ...
        <div id="rekappresensi">
            <h4>Rekap Presensi Bulan {{ $namabulan[$bulanini] }} Tahun {{ $tahunini }}</h3>
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !Important; line-height: 0.8rem">
                            ...
                            <ion-icon name="accessibility-outline" style="font-size: 1.6rem;" class="text-blue mb-1"></ion-icon><br>
                        ...
                        <li>
                            <div class="item">
                                ...
                                <div class="in">
                                    ...
                                    <span class="badge {{ $d->jam_in < "08:02 " ? "bg-success" : "bg-danger"}}">{{ $d->jam_in }}</span>
                                </div>
                            </div>
                        </li>
                        @endforeach
